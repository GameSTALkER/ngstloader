...
if _G.PlayerConnections ~= nil then
    for i,v in pairs(_G.PlayerConnections) do
...
function get(plr, msg)
    ...
    if translation then
        properties.Text = "("..tab[2]:upper()..") ".."[".. plr.DisplayName .."]: "..translation
...
for i, plr in ipairs(Players:GetPlayers()) do
    if plr.Name ~= Players.LocalPlayer.Name then 
        _G.PlayerConnections[plr.Name] = plr.Chatted:Connect(function(msg)
            get(plr, msg)
        end)
    end
end
...
Players.PlayerRemoving:Connect(function(plr)
    _G.PlayerConnections[plr.Name]:Disconnect()
end)
