...
if _G.keyinput ~= nil then _G.keyinput:Disconnect() end
_G.keyinput = game:GetService("UserInputService").InputBegan:Connect(function(key,enter)
...
diedcon = Character:WaitForChild("Humanoid").Died:Connect(function()
    _G.keyinput:Disconnect()
    _G.keyinput = nil
    diedcon:Disconnect()
end)
